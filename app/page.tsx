...
export default function LekhaFlowLanding() {
  ...
  const [clientForm, setClientForm] = useState({ clientName: "", companyName: "", mobileNumber: "" });
  ...
  const t = {
    ...
    process: {
      ...
      steps: [
        { s: "01", t: "GUI", d: isHindi ? "यूजर इंटरफेस" : "User Interface", img: "/gui_screen_1.png", i: MousePointer2 },
        { s: "02", t: isHindi ? "इनवॉइस अपलोड" : "UPLOAD THE INVOICE", d: "PDF / Image / Excel", img: "/gui_screen_2.png", i: Download },
        { s: "03", t: isHindi ? "जेनरेट" : "GENERATE", d: isHindi ? "एआई डेटा एक्सट्रैक्शन" : "AI Data Extraction", img: "/gui_screen_3.png", i: Zap },
        { s: "04", t: isHindi ? "आउटपुट" : "OUTPUT", d: isHindi ? "XML फाइलें तैयार" : "XML Files Ready", img: "/gui_screen_4.png", i: FolderOutput },
        { s: "05", t: isHindi ? "इम्पोर्ट" : "IMPORT", d: isHindi ? "वन-क्लिक टैली इम्पोर्ट" : "One-Click Tally Import", img: "/gui_screen_5.png", i: FileText },
        { s: "06", t: isHindi ? "एंट्री हो गई" : "THE ENTRY", d: isHindi ? "वाउचर बन गया" : "Voucher Created", img: "/gui_screen_6.png", i: Database }
      ]
    },
    trust: {
  ...
  const productData = {
    lite: { title: "Lite Edition", price: "15,000", limit: "2,000", tagline: isHindi ? "बेसिक एक्सेल मैपर" : "Basic Excel Mapper", razorpay: "https://rzp.io/rzp/SkJTqlgi" },
    standard: { title: "Standard Sync", price: "25,000", limit: "5,000", tagline: isHindi ? "टैली ऑटो एंट्री" : "Tally Auto Entry", razorpay: "https://rzp.io/rzp/oVwLNxHT" },
    premium: { title: "Premium Suite", price: "25,000", limit: "10,000", tagline: isHindi ? "प्रीमियम एआई इंजन" : "Premium AI Engine", razorpay: "https://rzp.io/rzp/9HGERapH" },
    gold: { title: "Gold Advance", price: "30,000", limit: "Unlimited*", tagline: isHindi ? "सबसे उन्नत स्वचालन" : "Advanced Automation", razorpay: "https://rzp.io/rzp/sQg7LGy" },
    erp9_standard: { title: "ERP9 Standard", price: "25,000", limit: "5,000", tagline: isHindi ? "लेगेसी सपोर्ट" : "Legacy Support", razorpay: "https://rzp.io/rzp/AZMi622y" },
    erp9_premium: { title: "ERP9 Premium", price: "35,000", limit: "Unlimited*", tagline: isHindi ? "ERP9 एडवांस" : "ERP9 Advance", razorpay: "https://rzp.io/rzp/BLZgsWB" }
  };
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* 1. NAVIGATION */}
      <nav className="fixed top-0 w-full z-[100] bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 no-print">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button onClick={() => triggerIntake("demo")} className="bg-white text-black px-10 py-5 rounded-2xl font-black uppercase hover:bg-teal-500 transition-all shadow-2xl">Watch Demo</button>
              <button onClick={() => triggerIntake("demo")} className="bg-slate-900 border border-slate-700 text-white px-10 py-5 rounded-2xl font-black uppercase">Download Trial</button>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {t.process.steps.map((step, i) => (
              <motion.div key={i} whileHover={{ y: -10 }} className="bg-slate-900 border border-slate-800 rounded-[2rem] overflow-hidden group transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-900 border-2 border-slate-800 rounded-[4rem] p-10 lg:p-20 shadow-2xl grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="grid gap-6">
                ...
                <div className="bg-teal-500 p-10 rounded-3xl text-center text-black shadow-xl shadow-teal-500/10">
      ...
      <section className="py-24 bg-slate-900/20 no-print">
        <div className={`${containerClass}`}>
          <h2 className="text-center text-3xl md:text-5xl font-black text-white mb-20 uppercase italic">{t.blog.title}</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <article key={i} className="bg-slate-900 border border-slate-800 rounded-[2.5rem] overflow-hidden hover:border-teal-500 transition-all shadow-xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="bg-slate-950 border-2 border-slate-800 rounded-[4rem] p-10 lg:p-20 relative overflow-hidden group shadow-2xl grid lg:grid-cols-3 gap-16 items-center">
              ...
              <div className="lg:col-span-2 space-y-8 text-center lg:text-left">
                 ...
                 <p className="text-teal-500 font-black uppercase tracking-widest text-xs italic">Nexoriva Systems | Surajpur, Chhattisgarh</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            {Object.entries(productData).map(([key, p]) => (
              <div key={key} className={`bg-slate-950 border p-6 rounded-[2.5rem] flex flex-col justify-between transition-all group ${activeTab === key ? 'border-teal-500 ring-4 ring-teal-500/10 shadow-2xl' : 'border-slate-800 hover:border-slate-700'}`}>
                <div className="space-y-4">
                ...
                <div className="mt-8 space-y-2">
                  ...
                  <a href={p.razorpay} target="_blank" rel="noreferrer" className="block w-full py-3 bg-teal-500 text-black rounded-xl text-[9px] font-black uppercase text-center shadow-lg active:scale-95 transition-transform">Buy Now</a>
                </div>
              </div>
            ))}
          </div>
