    ...
    <div className="min-h-screen bg-white py-32 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              <Database className="text-teal-500" size={24} />
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">1. Data Processing Philosophy</h2>
            </div>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
              LekhaFlow is designed with a <strong className="text-slate-950">local-first architecture</strong>. All invoice PDFs, bank statements, 
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">2. Information We Collect</h2>
            </div>
            <ul className="space-y-3 text-slate-600 text-sm leading-relaxed">
              <li className="flex items-start gap-3">
                <span className="text-teal-500 mt-1">•</span>
                <span><strong className="text-slate-950">Payment Information:</strong> Name, email, phone number, company name, and Razorpay payment ID collected during checkout.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-teal-500 mt-1">•</span>
                <span><strong className="text-slate-950">Machine Identifier:</strong> A unique hardware ID generated from your computer's components, used solely for license binding.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-teal-500 mt-1">•</span>
                <span><strong className="text-slate-950">Usage Analytics:</strong> Optional anonymized crash reports and feature usage statistics to improve the software.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">3. How We Use Your Information</h2>
            </div>
            <ul className="space-y-3 text-slate-600 text-sm leading-relaxed">
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">4. Data Retention & Deletion</h2>
            </div>
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              To request deletion, email <strong className="text-slate-950">support@lekhaflow.in</strong> or WhatsApp <strong className="text-slate-950">+91-87708-08695</strong>.
            </p>
          </section>

          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg mb-4">5. Contact</h2>
            <p className="text-slate-600 text-sm leading-relaxed">
              For privacy-related queries, contact:<br />
              <strong className="text-slate-950">Jitendra Bharti</strong>, Founder<br />
