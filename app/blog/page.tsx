    ...
    <div className="bg-white min-h-screen py-32 px-4">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-20">
          ...
          <p className="text-slate-600 font-bold uppercase tracking-[0.3em] text-sm">Professional Guides for the Modern Accountant</p>
        </header>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogList.map((post) => {
            ...
            return (
              <article key={post.slug} className="bg-slate-50 border border-slate-200 p-8 rounded-[3rem] hover:border-teal-500/50 transition-all flex flex-col justify-between group">
                <div>
                  ...
                  <h2 className="text-2xl font-black text-slate-950 leading-tight mb-4 group-hover:text-teal-700 transition-colors">{post.title}</h2>
                  <p className="text-slate-600 text-sm leading-relaxed mb-8">{post.desc}</p>
                </div>
