...
export default function HowItWorksPage() {
  return (
    <main className="min-h-screen bg-white text-slate-950">
      <section className="relative overflow-hidden bg-white px-6 py-24 text-slate-950 lg:px-10 lg:py-32">
        ...
        <div className="relative mx-auto max-w-7xl">
          <Link
            href="/"
            className="mb-14 inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.22em] text-teal-700 transition hover:text-slate-950"
          >
          ...
          <div className="max-w-5xl">
            <p className="mb-5 text-xs font-black uppercase tracking-[0.32em] text-teal-700">
            ...
            <h1 className="text-5xl font-black leading-[0.95] tracking-[-0.04em] sm:text-6xl lg:text-8xl">
              ...
              <span className="block text-teal-700">to Tally.</span>
            </h1>
          ...
          <div className="mt-14 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <ShieldCheck className="mb-4 text-teal-700" size={25} />
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <Eye className="mb-4 text-teal-700" size={25} />
              <p className="text-sm font-black uppercase tracking-widest">
                Review before Tally
              </p>
              <p className="mt-2 text-sm leading-6 text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <CheckCircle2 className="mb-4 text-teal-700" size={25} />
              <p className="text-sm font-black uppercase tracking-widest">
                Structured workflow
              </p>
              <p className="mt-2 text-sm leading-6 text-slate-600">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="space-y-5">
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.number}>
                  <article id={step.number === "03" ? "review" : step.number === "04" ? "export" : undefined} className="group grid overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl lg:grid-cols-[110px_1fr_220px]">
                    <div className="flex items-center justify-center bg-white p-6 text-4xl font-black text-slate-950 lg:text-5xl">
                      {step.number}
                    </div>
      ...
      <section className="bg-white px-6 py-20 lg:px-10 lg:py-28">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-white p-8 text-slate-950 sm:p-12 lg:p-16">
