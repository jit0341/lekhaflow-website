        ...
        <div className="space-y-12">
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">Eligibility for Refund</h2>
            </div>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
              You are eligible for a full refund within <strong className="text-slate-950">7 calendar days</strong> from the date of license activation 
            ...
            <ul className="space-y-3 text-slate-600 text-sm leading-relaxed">
              ...
              <li className="flex items-start gap-3"><span className="text-teal-500 mt-1">•</span>The software does not perform as demonstrated during the product demonstration</li>
            </ul>
          </section>
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">Non-Refundable Cases</h2>
            </div>
            <ul className="space-y-3 text-slate-600 text-sm leading-relaxed">
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">Refund Process</h2>
            </div>
            <ol className="space-y-4 text-slate-600 text-sm leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                <span>Send a refund request via WhatsApp to <strong className="text-slate-950">+91-87708-08695</strong> or email <strong className="text-slate-950">support@lekhaflow.in</strong> with your Razorpay payment ID.</span>
              </li>
              <li className="flex items-start gap-3">
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-slate-950 font-black uppercase tracking-widest text-lg">Need Help Instead?</h2>
            </div>
