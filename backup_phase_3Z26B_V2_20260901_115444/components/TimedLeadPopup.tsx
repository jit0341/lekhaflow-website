            ...
            {!submitted ? (
              <div className="p-7 sm:p-10">
                ...
                <p className="mt-3 max-w-md text-sm leading-6 text-slate-600">
                  {isHindi ? "à¤…à¤ªà¤¨à¤¾ à¤•à¤¾à¤® à¤¬à¤¤à¤¾à¤‡à¤à¥¤ à¤¹à¤® à¤†à¤ªà¤•à¥‹ LekhaFlow à¤•à¤¾ à¤¸à¤¹à¥€ workflow à¤”à¤° trial à¤¸à¤®à¤à¤¾à¤à¤à¤—à¥‡à¥¤" : "Tell us about your workflow. Weâ€™ll show you the right LekhaFlow setup and trial path."}
                </p>
                ...
                <p className="mt-3 text-center text-[9px] font-bold uppercase tracking-widest text-slate-400">{isHindi ? "à¤•à¥‹à¤ˆ spam à¤¨à¤¹à¥€à¤‚ â€¢ à¤¸à¤¿à¤°à¥à¤« LekhaFlow à¤¸à¤¹à¤¾à¤¯à¤¤à¤¾" : "No spam â€¢ Only LekhaFlow assistance"}</p>
              </div>
            ) : (
              <div className="px-8 py-14 text-center sm:px-12">
                ...
                <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-600">{isHindi ? "à¤¹à¤® à¤†à¤ªà¤•à¥‡ à¤¦à¤¿à¤ à¤—à¤ à¤µà¤¿à¤µà¤°à¤£ à¤•à¥‡ à¤†à¤§à¤¾à¤° à¤ªà¤° à¤†à¤ªà¤¸à¥‡ à¤¸à¤‚à¤ªà¤°à¥à¤• à¤•à¤°à¥‡à¤‚à¤—à¥‡à¥¤" : "Weâ€™ll contact you using the details you provided."}</p>
