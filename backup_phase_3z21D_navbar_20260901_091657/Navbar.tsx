                ...
                <div className="w-80 rounded-2xl border border-slate-200 bg-white p-3 shadow-2xl">
                  <div className="px-3 pb-2 pt-1">
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-teal-600">
                      {isHindi ? "ल े ख ा फ ् ल ो क ी क ् ष म त ा ए ँ" : "LekhaFlow Capabilities"}
                    </p>
                    <p className="mt-1 text-[11px] font-medium text-slate-500">
                      {isHindi ? "ए क ह ी Standard workflow क े भ ी त र" : "Built into the LekhaFlow Standard workflow"}
                    </p>
                  </div>
                  ...
                  <div className="mt-2 border-t border-slate-100 px-3 pt-3">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
                      {isHindi ? "Standard अ भ ी उ प ल ब ् ध ह ै • Gold / Advanced भ व ि ष ् य क े ल ि ए" : "Standard is live â€¢ Gold / Advanced are future products"}
                    </p>
                  </div>
                </div>
              </div>
