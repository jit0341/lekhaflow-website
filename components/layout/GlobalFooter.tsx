      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <p className="text-xl font-black tracking-tight text-slate-950">Lekha<span className="text-teal-700">Flow</span></p>
          ...
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-600">Product</p>
          ...
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-600">Company</p>
            <div className="mt-4 space-y-2 text-sm">
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-slate-200 pt-6 text-xs sm:flex-row sm:items-center sm:justify-between">
          ...
          <span>Built for practical Tally workflows.</span>
        </div>
      </div>
    </footer>
  );
