...
const content = {
  ...
  bank: {
    ...
    desc:
      "Import bank statements, review transactions, use SwiftAssign(TM) to resolve repetitive ledger assignments, export the result and send resolved entries to Tally.",
    ...
    steps: [
      ...
      "Use SwiftAssign(TM) for bulk grouping",
    ...
    benefits: [
      ...
      "SwiftAssign(TM) bulk ledger assignment",
...
export default function ProductMarketingPage({
  ...
  const labels = {
    review: false ? "Tally à¤®à¥‡à¤‚ à¤­à¥‡à¤œà¤¨à¥‡ à¤¸à¥‡ à¤ªà¤¹à¤²à¥‡ à¤ªà¥‚à¤°à¤¾ result à¤¦à¥‡à¤–à¥‡à¤‚" : "Review before sending to Tally",
    workflow: false ? "à¤¯à¤¹ à¤•à¥ˆà¤¸à¥‡ à¤•à¤¾à¤® à¤•à¤°à¤¤à¤¾ à¤¹à¥ˆ" : "How it works",
    benefits: false ? "à¤®à¥à¤–à¥à¤¯ capabilities" : "Key capabilities",
    excel: false ? "Excel Export à¤­à¥€ à¤‰à¤ªà¤²à¤¬à¥à¤§" : "Excel Export is included",
    cta: false ? "Free Trial à¤¶à¥à¤°à¥‚ à¤•à¤°à¥‡à¤‚" : "Start Free Trial",
    talk: false ? "WhatsApp à¤ªà¤° à¤¬à¤¾à¤¤ à¤•à¤°à¥‡à¤‚" : "Talk to us on WhatsApp",
  };
