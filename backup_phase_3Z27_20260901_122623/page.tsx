...
tagline: isHindi ? "MSME AI " : "Essential AI Automation for MSMEs",
features: [
isHindi ? " -> ()" : "Bank Statement -> Tally (Unlimited)",
isHindi ? "PDF / -> " : "PDF / Image Invoice -> Tally",
isHindi ? " " : "Excel True Copy Export",
isHindi ? " " : "Auto Ledger & Stock Creation",
isHindi ? "10,000, 30,000 50,000 " : "Sales Split Below 10,000, 30,000 or 50,000",
isHindi ? " " : "Email Support"
],
...
const t = {
hero: {
badge: isHindi ? "AI -> " : "AI-POWERED ACCOUNTING AUTOMATION -> TALLY",
title: isHindi ? (
...
trust: [
{ i: Cpu, t: isHindi ? "AI " : "AI-Powered Automation", d: isHindi ? ", PDF " : "Process invoices, bank statements and accounting documents with AI.", c: "text-purple-500" },
{ i: ShieldCheck, t: isHindi ? " " : "Client-Side Data Control", d: isHindi ? " " : "Designed around client-side processing and data control.", c: "text-teal-500" },
{ i: Target, t: isHindi ? " " : "Review Before Tally", d: isHindi ? "AI , , Tally " : "AI prepares. You review. Then send the final entries to Tally.", c: "text-blue-500" },
{ i: Zap, t: isHindi ? " " : "Sales Split Advantage", d: isHindi ? " " : "Automatically split a sales total into multiple vouchers.", c: "text-amber-500" }
]
};
...
{isHindi ? " " : "No Cloud Storage"}
</p>
<p className="text-slate-900 text-[10px] leading-relaxed">
{isHindi ? " " : "Data never leaves your system"}
</p>
</div>
</div>
<div className="bg-white/50 border border-slate-200 p-6 rounded-2xl flex items-start gap-4">
...
<div>
<p className="text-slate-900 font-black text-xs uppercase tracking-widest">
{isHindi ? " " : "Full Control"}
</p>
<p className="text-slate-900 text-[10px] leading-relaxed">
{isHindi ? " " : "You decide who accesses what"}
</p>
</div>
</div>
<div className="bg-white/50 border border-slate-200 p-6 rounded-2xl flex items-start gap-4">
...
<div>
<p className="text-slate-900 font-black text-xs uppercase tracking-widest">
{isHindi ? "CAs " : "Built for CAs"}
</p>
<p className="text-slate-900 text-[10px] leading-relaxed">
{isHindi ? " " : "Privacy is a professional responsibility"}
</p>
</div>
</div>
</div>
...
{isHindi ? " " : " WHO IS IT FOR"}
</p>
</div>
<h2 className="text-4xl md:text-5xl font-black text-slate-900 uppercase italic tracking-tighter mb-4">
{isHindi ? " " : "Who Is LekhaFlow For?"}
</h2>
</div>
...
<p className="text-teal-700 text-[10px] font-black uppercase tracking-[0.4em]">
{isHindi ? "4 " : "4 SIMPLE STEPS"}
</p>
</div>
<h2 className="text-4xl md:text-5xl font-black text-slate-900 uppercase italic tracking-tighter mb-4">
{isHindi ? " " : "How LekhaFlow Works"}
</h2>
<p className="text-slate-900 font-bold uppercase tracking-widest text-xs max-w-xl mx-auto">
{isHindi
? ", AI - Tally "
...
{[
{ num: "01", icon: FileText, title: isHindi ? "PDF " : "Upload Bank Statement", desc: isHindi ? " PDF " : "Select your bank statement PDF. The software auto-detects the bank format." },
{ num: "02", icon: Cpu, title: isHindi ? "AI " : "AI Reads & Categorizes", desc: isHindi ? "AI - , , / " : "AI reads every transaction, understands narration, and classifies Dr/Cr automatically." },
{ num: "03", icon: Landmark, title: isHindi ? " " : "Review in Smart Grid", desc: isHindi ? " - / -" : "All transactions appear in a clean grid. Opening/closing balance auto-validated." },
{ num: "04", icon: Send, title: isHindi ? "- " : "One-Click to Tally", desc: isHindi ? "'Send to Tally' " : "Hit 'Send to Tally'. All vouchers are created directly in your Tally - no XML import needed." },
].map((step, i) => (
...
{isHindi ? " : 75,000 -> 2 (40K + 35K) " : " Sales Split: 75,000 Invoice -> 2 Vouchers (40K + 35K) Automatic"}
</span>
</div>
</div>
</div>
...
{isHindi ? " " : "How the Free Demo Works"}
</h2>
<p className="text-slate-900 font-bold uppercase tracking-widest text-xs">
{isHindi ? " " : "No payment. No credit card required."}
</p>
</div>

<div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
{[
{ num: "01", title: isHindi ? " " : "Download", desc: isHindi ? "7- " : "Download the 7-day trial setup file (Windows 10/11)." },
{ num: "02", title: isHindi ? " " : "Install", desc: isHindi ? " " : "Install the software. Copy the Machine Hardware ID displayed." },
{ num: "03", title: isHindi ? " " : "Contact Us", desc: isHindi ? " 2 " : "Send the ID on WhatsApp. We send your trial license within 2 hours." },
{ num: "04", title: isHindi ? " " : "See It in Tally", desc: isHindi ? " " : "Watch your bank statements and invoices flow into Tally automatically." },
].map((step, i) => (
...
{isHindi ? "GSTR-2B " : "GSTR-2B Reconciliation"}
</h3>
...
{isHindi ? " " : " Purchase Invoices"}
</span>
<span className="text-slate-900 text-[10px] font-bold uppercase tracking-widest border border-slate-200 px-4 py-2 rounded-full">
{isHindi ? " GSTR-2B " : " GSTR-2B Matching"}
</span>
<span className="text-slate-900 text-[10px] font-bold uppercase tracking-widest border border-slate-200 px-4 py-2 rounded-full">
{isHindi ? " " : " Mismatch Detection"}
</span>
</div>
</div>
</div>
...
{isHindi ? " " : "The Financial Impact of"} <span className="text-teal-500">{isHindi ? "" : "Automation"}</span>
</h2>
<div className="space-y-10">
<div className="space-y-4">
<label className="text-[10px] font-black text-teal-400 uppercase tracking-widest block">
{isHindi ? " / " : "Average Invoices / Month"}: {invoices}
</label>
...
<div className="space-y-4">
<label className="text-[10px] font-black text-teal-400 uppercase tracking-widest block">
{isHindi ? " " : "Current Staff Salary"}: {staffCost}
</label>
...
{isHindi ? " " : "Annual Operational Savings"}
</p>
...
<div className="text-center mb-16">
<h2 className="text-4xl md:text-5xl font-black text-slate-900 uppercase italic tracking-tighter mb-4">
{isHindi ? " " : "Frequently Asked Questions"}
</h2>
<p className="text-slate-900 font-bold uppercase tracking-widest text-xs">
{isHindi ? " " : "Answers you need"}
</p>
</div>
...
{isHindi ? " " : "Commitment to Accuracy"}
</h3>
...
{isHindi ? " - , " : "Jitendra Bharti - Founder, LekhaFlow"}
</p>
</div>
</div>
</div>
...
{isHindi ? " " : "Independence Day Launch Offer"}
</p>
</div>
<h2 className="text-4xl md:text-5xl font-black text-slate-900 uppercase italic tracking-tighter mb-4">
{isHindi ? " " : "Professional Licenses"}
</h2>
<p className="text-slate-900 font-bold uppercase tracking-widest text-xs mb-2">
{isHindi ? " 50 " : "Special pricing for first 50 clients only"}
</p>
<p className="text-amber-500 text-[10px] font-black uppercase tracking-widest">
{isHindi ? "31 2026 " : "Valid till 31st August 2026"}
</p>
</div>
...
{isHindi ? "7- - " : "7-Day Money-Back Guarantee - Not satisfied? Full refund"}
</p>
...
<div className="text-center mb-16">
<h2 className="text-3xl md:text-5xl font-black text-slate-900 uppercase italic tracking-tighter mb-4">
{isHindi ? " " : "What Accountants Say"}
</h2>
</div>
<div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
{[
{ name: "CA Rahul Sharma", firm: "Sharma & Associates, Raipur", quote: isHindi ? " 3 " : "Bank statement entry that used to take 3 hours now finishes in 10 minutes." },
{ name: "Priya Gupta", firm: "Gupta Tax Consultants, Bilaspur", quote: isHindi ? " " : "The Sales Split feature is powerful. No more manual calculations for GST compliance." },
{ name: "Rajesh Agrawal", firm: "Agrawal & Co., Ambikapur", quote: isHindi ? "7- 500 99% " : "Processed 500 invoices during the 7-day trial. 99% accuracy on first try." },
].map((t, i) => (
...
{isHindi ? " AI | " : "LekhaFlow AI | Engineering the Future of Indian Accounting "}
</p>
</div>
</footer>
