      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-6">
        ...
        <nav className="hidden lg:flex items-center gap-7">
                ...
                <div className="w-80 rounded-2xl border border-slate-200 bg-white p-3 shadow-2xl">
                  <div className="px-3 pb-2 pt-1">
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-teal-600">
                      {isHindi ? "à¤² à¥‡ à¤– à¤¾ à¤« à¥ à¤² à¥‹ à¤• à¥€ à¤• à¥ à¤· à¤® à¤¤ à¤¾ à¤ à¤" : "LekhaFlow Capabilities"}
                    </p>
                    <p className="mt-1 text-[11px] font-medium text-slate-500">
                      {isHindi ? "à¤ à¤• à¤¹ à¥€ Standard workflow à¤• à¥‡ à¤­ à¥€ à¤¤ à¤°" : "Built into the LekhaFlow Standard workflow"}
                    </p>
                  </div>
                  ...
                  <div className="mt-2 border-t border-slate-100 px-3 pt-3">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
                      {isHindi ? "Standard à¤… à¤­ à¥€ à¤‰ à¤ª à¤² à¤¬ à¥ à¤§ à¤¹ à¥ˆ â€¢ Gold / Advanced à¤­ à¤µ à¤¿ à¤· à¥ à¤¯ à¤• à¥‡ à¤² à¤¿ à¤" : "Standard is live Ã¢â‚¬Â¢ Gold / Advanced are future products"}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Sparkles size={14} />
              {isHindi ? "à¤Ÿà¥à¤°à¤¾à¤¯à¤² à¤²à¥‡à¤‚" : "Free Trial"}
            </Link>
          </div>
        </nav>
      ...
      {mobileOpen && (
        <div className="border-t border-slate-200 bg-white lg:hidden">
          <nav className="mx-auto max-w-7xl px-5 py-5">
            ...
            >
              <Sparkles size={15} />
              {isHindi ? "à¤«à¥à¤°à¥€ à¤Ÿà¥à¤°à¤¾à¤¯à¤² à¤¡à¤¾à¤‰à¤¨à¤²à¥‹à¤¡" : "Download Free Trial"}
            </Link>
          </nav>
        </div>
      )}
